...
<html lang="en">
    <head>
        ...
        <title>HPC Thanh Trì</title>
    </head>
    <body>
        <!-- navbar start -->
        <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
            <a class="navbar-brand" href="#">Buổi 1</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="blog-post">Trang chủ <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Giới thiệu về trường học</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row main-section">
                <div class="col-sm-12 col-md-9 col-lg-9">
                    <div class="card rounded-0 shadow-sm" >
                        ...
                        <div class="card-body">
                             <img class="card-img-top" src="img/hpc-thanh-tri-2022.png" alt="bootstrap simple blog">
                            <hr>
